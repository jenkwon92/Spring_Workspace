...
public class	GalleryController {
	...
	public String regist(Gallery gallery, HttpServletRequest request) {
		...
		System.out.println("getOriginalFilename is "+photo.getOriginalFilename());
		...
		//이클립스 내부 톰캣인 경우, 실제 경로와는 다른 경로에 저장. 개발시엔 그 경로를 확인하려면
		//출력
	...
	public String edit(Gallery gallery) {
		...
		//4단계: 저장할 것이 없다, 왜?요청을 끊고 detail를 새로 접속할 거니까 
