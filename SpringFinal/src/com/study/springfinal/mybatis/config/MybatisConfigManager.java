/*
 ...
 정의한 객체, 특히 이 객체의 인스턴스는 어플리케이션내에서 1개만 둬야하므로 SingleTon 패턴으로 정의한다
  */
...
public class MybatisConfigManager {
	...
	//3) getter는 제공했으마, 역시 인스턴스 메서드이므로 new 한 다음에나 호출할 수 있기 때문에 
	//그 어떤 객체로 이 메서드를 호출할 수 없다(new를 막아 놓았으니)
