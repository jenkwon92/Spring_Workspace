...
out.print("요청객체에 담겨진 gallery는 " + gallery);
%>
<!DOCTYPE html>
<html>
<head>
...
<script>
	$(function() {
		...
		$($("input[type='button']")[1]).click(function() { // 글삭제
			del(); //동기방식으로 요청하겠다
		});
	...
	function del() {
		if (confirm("삭제하시겠어요?")) {
			$("form").attr({
				...
				method : "post" /*form태그안에 있는 히든값인 board_id 가 전송됨*/
			});
			$("form").submit();
		}
	}
...
<body>
	...
	<div class="container">
		<form>
			...
			<input type="button" value="글수정"> <input type="button"
				value="글삭제"> <input type="button" value="목록보기"
				onClick="location.href='/gallery/list'">
			<div class="reply-box">
				<input type="text" name="msg" placeholder="댓글 입력.."
					style="width: 75%"> <input type="text" name="author"
					placeholder="작성자 입력.." style="width: 15%">
