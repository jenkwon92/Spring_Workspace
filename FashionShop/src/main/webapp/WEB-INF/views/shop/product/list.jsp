...
<head>
	...
	$(function(){
		...
		$(".product-quicview").on("click",function(e){
			...
			console.log(product_id); //product_id를 안다면, 모든 상품정보로 가져올 가능성이 있다
			...
			//퀵뷰창의 상품 정보에 출력
			//이미지
			$(".quickview_pro_img img").attr({//이미지 교체 (한칸 띄면 자식을 의미)
			...
			$(".quickview_pro_des p").html(detail); //상세정보
			$(".quickview_pro_des a").on("click",function(){
				//alert(product_id+"를 보기를 원해?");
                                    ...
                                    <div class="product-img">
                                        ...
                                        <div class="product-quicview">
                                            ...
                                            <i class="ti-plus" 
                                            	...
                                            	data-filename="<%=product.getFilename() %>"></i></a>
                                        </div>
                                    </div>
                                    <!-- Product Description -->
