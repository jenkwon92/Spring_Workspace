                            ...
                            <form id="checkout-form">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        <label for="first_name">주문고객 성명<span>*</span></label>
                                        <input type="text" class="form-control" id="member_id" value="<%=member.getName() %>" required>
                                    </div>
                                    <div class="col-md-6 mb-3">
								...
								<div class="col-md-6 mb-3">
									<label for="first_name">받으실 분 성명<span>*</span></label> <input
										type="text" class="form-control" id="first_name" name="receiver_name" value=""
										required>
								</div>
								<div class="col-md-6 mb-3">
									<label for="last_name">연락처<span>*</span></label> <input
										type="text" class="form-control" id="last_name" name="receiver_phone" value=""
										required>
								</div>
								<div class="col-12 mb-3">
									<label for="company">받으실 주소</label> <input type="text"
										class="form-control" id="company" value="">
								</div>

								<div class="col-12 mb-3">
                                        <label for="country">결제 방법 선택 <span>*</span></label>
                    ...
                    <div class="col-12 col-md-6 col-lg-5 ml-lg-auto">
                        <div class="order-details-confirmation">
                            ...
                            <ul class="order-details-form mb-4">
                                ...
                                <li><span>할인쿠폰</span> <span>-$10.00</span></li>
                                <li><span>최종 결제 금액</span> <span>$49.90</span></li>
                            </ul>
